...
class ChambreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $chambres = $em->getRepository('MainBundle:Chambre')->findAll();
    ...
    {
        $chambre = new Chambre();
        $form = $this->createForm('MainBundle\Form\ChambreType', $chambre);
    ...
    {
        $deleteForm = $this->createDeleteForm($chambre);
        $editForm = $this->createForm('MainBundle\Form\ChambreType', $chambre);
